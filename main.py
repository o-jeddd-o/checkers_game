...
from checkers_gui.checkers_gui import CheckersGUI  # Updated import path
...
# Create an instance of the CheckersGUI class and run the GUI, passing the game board
gui = CheckersGUI(board.board)  # Pass the game board to the constructor
gui.run()
